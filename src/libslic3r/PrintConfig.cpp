...
void PrintConfigDef::init_fff_params()
{
    ...
    def->label    = L("Print infill first past first layer");
    ...
    def = this->add("is_infill_first_on_first_layer",coBool);
    def->label    = L("Print infill first on first layer");
    def->tooltip  = L("Order of wall/infill. Same as above; note printing infill first on the first layer may lower adhesive force.");
    def->category = L("Quality");
    def->mode     = comAdvanced;
    def->set_default_value(new ConfigOptionBool{false});
