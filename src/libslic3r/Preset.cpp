...
static std::vector<std::string> s_Preset_print_options {
    ...
    "seam_position", "staggered_inner_seams", "wall_sequence", "is_infill_first", "is_infill_first_on_first_layer", "sparse_infill_density", "sparse_infill_pattern", "top_surface_pattern", "bottom_surface_pattern",
